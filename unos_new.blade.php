...
<html lang="en">
  ...
  >
      ...
      <div class="navbar-custom" id="topNav">
        <div class="container-fluid">
          ...
          <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
            ...
            <li id="pretragaMenu" style="margin-left: 2px">
              <button class="button-menu-mobile waves-effect waves-light" data-bs-toggle="tooltip" data-bs-trigger="hover" id="pretraga" data-bs-placement="bottom" data-bs-original-title="Filtriranje">
                <i data-feather="search"  style="transform: translateY(-3px); color: white"></i>
              </button>
            </li>
        ...
        <div class="h-100" data-simplebar>
          ...
          <div id="sidebar-menu">
            <ul id="side-menu">
              ...
              <li id="masovnoBrisanjeDiv">
                <a id="brisanjeViseObjekata">
    ...
    <div id="potvrdaProduzenjaKrakaDiv" class="sidenav">
      ...
      <div class="d-flex-end items-padd-sm">
        <p id="produzenjeVodaPoruka">Kliknite jos jednom na vod koji zelite da pomjerite. Sistem ce ga oznaciti tamno plavom bojom.</p>
        <button type="button" class="btn btn-success mr-8" id="btnPotvrdiProduzenjeKraka" style="display: none;">
          <i class="fas fa-check-circle"></i> Potvrdi
        </button>
      </div>
    </div>
      ...
      <div class="items-padd">
        <div class="pr-8 sadrzaj-scroll style-2">
          ...
          <div class="flex-row-desno pb-8" id="divUnosName">
            <label for="name"><span id="spanUnosName">Naziv</span>: <b class="fontB">*</b></label>
          ...
          <div class="flex-row-desno pb-8" id="divUnosTipStub">
            <label for="tip_stub">Tip stuba:</label>
            <select id="tip_stub" class="select-css"></select>
          </div>

          <div class="flex-row-desno pb-8" id="divTopologijaMreze">
            <label for="topologija_mreze">Topologija mreže:</label>
            <select id="topologija_mreze" class="select-css">
              <option>Izaberite vrijednost</option>
              <option value="Radijalna">Radijalna</option>
              <option value="Prstenasta">Prstenasta</option>
            </select>
          </div>
          ...
          <div class="flex-row-desno pb-8" id="divUnosBrFaza">
            <label for="br_faza">Broj faza:</label>
          ...
          <div class="flex-row-desno pb-8" id="divUnosBrSpojnica">
            <label for="br_spojnica">Broj spojnica:</label>
          ...
          <div class="flex-row-desno pb-8" id="divUnosUzeVod10">
            <label for="uze_vod_10">Zaštitno uže materijal:</label>
          ...
          <div class="flex-row-desno pb-8 trafostaniceTop trafostaniceLeft" id="divUnosDdlTrafostanice">
          ...
          <div class="flex-row-desno pb-8 trafostaniceLeft" id="divReadNaziv">
            <label for="read_naziv">Naziv TBP:</label>
            <input type="text" id="read_naziv" readonly class="disabledInput" />
          </div>
          <div class="flex-row-desno pb-8 trafostaniceLeft" id="divReadCelije10">
    ...
    <div id="pretragaDiv" class="sidenav">
      ...
      <div class="items-padd">
        ...
        <div class="flex-row rowEnd pb-8">
          ...
          <div class="flex-row rowEnd pb-8" id="divPretragaTrafostanicaTip">
            <label for="pretraga_tip_trafostanica">Tip:</label>
            <select id="pretraga_tip_trafostanica" class="select-css inputClass">
              <option></option>
              ...
              <option value="RASKLOPISTE">RASKLOPISTE</option>
              <option value="STS 10/0,4 kV">STS 10/0,4 kV</option>
              <option value="STS 10/0,4kV">STS 10/0,4kV</option>
              <option value="TS (zidana)">TS (zidana)</option>
              <option value="TS-O (u sklopu objekta)">TS-O (u sklopu objekta)</option>
            </select>
          </div>
          <div class="flex-row rowEnd pb-8" id="divPretragaVodoviTip">
            <label for="pretraga_tip_vodovi">Tip:</label>
            <select id="pretraga_tip_vodovi" class="select-css inputClass">
              <option></option>
              <option value="IPO 13">IPO 13</option>
              <option value="IPZO 13">IPZO 13</option>
              <option value="Kabal">Kabal</option>
              <option value="kabal jednozilni">kabal jednozilni</option>
              <option value="Kablovski(podzemni)">Kablovski(podzemni)</option>
              <option value="PHP 41">PHP 41</option>
              <option value="PHP 48">PHP 48</option>
              <option value="PHP 81">PHP 81</option>
              <option value="PP 00">PP 00</option>
              <option value="PP 41">PP 41</option>
              <option value="PP OO">PP OO</option>
              <option value="PP00">PP00</option>
              <option value="uze">uze</option>
              <option value="Uže">Uže</option>
              <option value="X 00/0-A  (SKS)">X 00/0-A  (SKS)</option>
              <option value="X 00/0-A (SKS)">X 00/0-A (SKS)</option>
              <option value="X 00-A  (SKS)">X 00-A  (SKS)</option>
              <option value="X 00-A (SKS)">X 00-A (SKS)</option>
              <option value="X00/0">X00/0</option>
              <option value="XHE 48 Jednozilni">XHE 48 Jednozilni</option>
              <option value="XHE 48/0-A (SNSKS)">XHE 48/0-A (SNSKS)</option>
              <option value="XHE 49 jednozilni">XHE 49 jednozilni</option>
              <option value="XHP 48">XHP 48</option>
              <option value="XHP 48 jednozilni">XHP 48 jednozilni</option>
              <option value="XHP 48 trozilni">XHP 48 trozilni</option>
              <option value="XHP 48/0-A (SNSKS)">XHP 48/0-A (SNSKS)</option>
              <option value="XHP 49 jednozilni">XHP 49 jednozilni</option>
              <option value="XHP 81">XHP 81</option>
              <option value="XP 00">XP 00</option>
            </select>
          </div>
          ...
          <div class="flex-row rowEnd pb-8" id="divPretragaVodoviMaterijal">
            <label for="pretraga_vodovi_materijal">Materijal:</label>
            <select id="pretraga_vodovi_materijal" class="select-css inputClass">
              <option></option>
              <option value="ACCC Rijeka">ACCC Rijeka</option>
              <option value="Al">Al</option>
              <option value="AlFe">AlFe</option>
              <option value="AlFe + Fe">AlFe + Fe</option>
              <option value="AlFe+Fe">AlFe+Fe</option>
              <option value="AlMg">AlMg</option>
              <option value="Bronza">Bronza</option>
              <option value="Cu">Cu</option>
              <option value="Fe">Fe</option>
              <option value="materijal voda">materijal voda</option>
              <option value="PP 00">PP 00</option>
              <option value="XHE 49A">XHE 49A</option>
            </select>
          </div>
