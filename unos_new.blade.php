...
<html lang="en">
  <head>
    ...
    <!-- App favicon -->
    <link rel="shortcut icon" href="../../administracija/olcedis/img/logo.png" />
  ...
  >
        ...
        <div class="container-fluid">
          ...
          <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
            ...
            <li id="potvrdaMenu" style="margin-left: 2px">
              ...
              data-bs-trigger="hover" data-bs-placement="bottom" data-bs-original-title="Potvrda">
        ...
        <div class="h-100" data-simplebar>
          ...
          <div id="sidebar-menu">
            <ul id="side-menu">
              ...
              <li>
                <a href="#" data-bs-toggle="collapse" id="brisanje">
              ...
              <li>
                ...
                <div class="collapse" id="sidebarCrm2">
                  <ul class="nav-second-level2">
                    ...
                    <li>
                      <a href="#sidebarMultilevel2" data-bs-toggle="collapse" class="dropdown-item">
                          ...
                          <ul class="nav-second-level">
                            <li>
                              <a href="#" id="snapStub35" class="dropdown-item">
                                <i data-feather="toggle-left" style="width: 18px;"></i>
                  ...
                  <li>
                    <a href="#sidebarMultilevel3" data-bs-toggle="collapse" class="dropdown-item">
    ...
    <div id="pretragaDiv" class="sidenav">
      ...
      <div class="d-flex-end items-padd-sm">
        <button type="button" class="btn btn-outline-danger waves-effect mr-8" id="btnPonistiFilter">
          <i class="icon-close" style="transform: translateY(1px);"></i> Poništi filter
        </button>
        <button type="button" class="btn btn-outline-success" id="btnFilter">
