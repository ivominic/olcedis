...
function popuniKontrole(odgovor) {
  ...
  document.querySelector("#duzina").value = atributi["duzina"];
  document.querySelector("#rac_duzina").value = atributi["rac_duzina"];
...
function restartovanje() {
  ...
  document.querySelector("#duzina").value = "";
  document.querySelector("#rac_duzina").value = "";
...
function kreiranjeCqlFilteraAtributi() {
  ...
  document.querySelector("#pretraga_duzina").value !== "" && (retVal += "duzina = '" + document.querySelector("#pretraga_duzina").value + "' AND ");
  document.querySelector("#pretraga_rac_duzina").value !== "" && (retVal += "rac_duzina = '" + document.querySelector("#pretraga_rac_duzina").value + "' AND ");
